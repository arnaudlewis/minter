...
description
  ...
  and what this means for test generation and implementation. The output
  is designed for both human authors and AI agents consuming minter
  through MCP.
...
motivation
  ...
  generation. Without this, the agent treats specs as syntax to parse
  rather than a development methodology to follow. The explain command
  makes the methodology machine-discoverable.
